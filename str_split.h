 ...
 *
 * Function str_split() splits a string ('str') into string tokens (a token is
 * also a string). This function uses the 'delim' string to split 'str' into
 * tokens. If a 'delim' is found at position "i", then the token ends at the
 * position "i - 1".
 *
